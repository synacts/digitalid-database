 ...
 */
@Immutable
public abstract class SQLConverterOld<O, E> {
    ...
    SQLConverterOld<O, E> redeclaredWith(@Nonnull @Matching Declaration declaration) {
    ...
    @Pure
    public final @Nonnull
    SQLConverterOld<O, E> prefixedWith(@Nonnull SQLPrefix prefix) {
     ...
     */
    protected SQLConverterOld(@Nonnull Declaration declaration) {
    ...
    public final void storeNullable(@Nullable O object, @NonCapturable @Nonnull ValueCollector collector) throws FailedValueStoringException {
        ...
        else { SQLConverterOld.this.storeNonNullable(object, collector); }
    }

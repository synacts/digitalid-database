package net.digitalid.database.conversion.converter.primitive.integer;
...
/**
 * The integer converter converts and recovers integer types into and from SQL cells.
 */
public class SQLInteger32Converter extends SQLSingleRowConverter<Integer> {
    ...
    @Override
    public @Nullable Integer recoverNullable(@Nonnull Class<?> type, @NonCapturable @Nonnull SelectionResult result, @Nonnull @NonNullableElements Annotation[] annotations) throws CorruptNullValueException, FailedValueRestoringException, StructureException, ConverterNotFoundException, RecoveryException {

...
//    @Pure
//    @Override
//    public @Nonnull Pair<@Nonnull SQLColumnDeclaration, @Nonnull ImmutableList<@Nonnull CustomAnnotation>> getColumnDeclaration(@Nonnull String columnName, @Nullable CustomType type, @Nonnull ImmutableList<@Nonnull CustomAnnotation> annotations) {
...
//    @Pure
//    @Override
//    protected @Nonnull CustomType getColumnType(@Nonnull SQLColumnDeclaration columnDeclaration) {

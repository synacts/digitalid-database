...
public class SQLCollectionsConverter extends SQLConverter<Collection<?>> {
    ...
    private <T extends Copyable<T>> List<FreezableArrayList<T>> deepCopy(int n, ReadOnlyList<T> list) {
     ...
     */
    private Class<?> getColumnType(@Nullable @NonNullableElements Annotation[] annotations) {
     ...
     */
    private Class<?> getGenericType(@Nullable @NonNullableElements Annotation[] annotations) {
        if (annotations != null) {
    ...
    private static class WrappedElement implements Convertible {
        ...
        public WrappedElement(int id, @Nullable Object element) {
            this.id = id;
    ...
    private boolean isAnnotatedWithEmbedd(@Nonnull @NonNullableElements Annotation[] annotations) {

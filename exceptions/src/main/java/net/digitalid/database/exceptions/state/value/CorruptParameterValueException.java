 ...
 */
@Immutable
public class CorruptParameterValueException extends CorruptValueException {
    ...
    /**
     * Creates a new corrupt parameter value exception with the given parameter and value.
     * 
     * @param parameter the parameter name whose value is invalid.
     * @param value the value decoded from a block which is invalid.
     */
    protected CorruptParameterValueException(@Nonnull String parameter, @Nonnull Object value) {
    ...
    /**
     * Returns a new corrupt parameter value exception with the given parameter and value.
     * 
     * @param parameter the parameter name whose value is invalid.
     * @param value the value decoded from a block which is invalid.
     * 
     * @return a new corrupt parameter value exception with the given parameter and value.
     */
    @Pure
    public static @Nonnull CorruptParameterValueException get(@Nonnull String parameter, @Nonnull Object value) {
        return new CorruptParameterValueException(parameter, value);
    }

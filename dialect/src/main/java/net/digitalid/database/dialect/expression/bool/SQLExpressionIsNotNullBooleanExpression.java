...
/**
 * An SQL expression that checks whether another expression is not null.
 */
@Immutable
@GenerateBuilder
@GenerateSubclass
public interface SQLExpressionIsNotNullBooleanExpression extends SQLBooleanExpression {

...
public class SQLUnorderedSelectStatementTest extends SQLStatementTest {
    ...
    public void testUnorderedSelectStatement() {
        ...
        assertThat(SQLDialect.unparse(selectStatement, Unit.DEFAULT)).isEqualTo("SELECT DISTINCT \"t\".* FROM ((\"default\".\"test_table\") INNER (\"default\".\"test_table\") USING (\"first_column\", \"second_column\", \"third_column\")) AS \"t\" WHERE (\"t\".\"first_column\") = (8.0) GROUP BY \"first_column\" HAVING (\"t\".\"first_column\") = (8.0)");
    }

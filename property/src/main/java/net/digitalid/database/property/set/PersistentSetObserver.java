...
/**
 * Objects that implement this interface can be used to {@link #register(net.digitalid.utility.property.Observer) observe} {@link ReadOnlyPersistentSetProperty persistent set properties}.
 */
@Mutable
@Functional

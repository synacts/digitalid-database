...
@GenerateBuilder
@GenerateSubclass
public abstract class WritablePersistentSimpleMapPropertyImplementation<SITE extends Site<SITE>, SUBJECT extends Subject<SITE>, KEY, VALUE> extends WritablePersistentMapPropertyImplementation<SITE, SUBJECT, KEY, VALUE, ReadOnlyMap<@Nonnull @Valid("key") KEY, @Nonnull @Valid VALUE>, FreezableMap<@Nonnull @Valid("key") KEY, @Nonnull @Valid VALUE>> implements WritablePersistentSimpleMapProperty<SUBJECT, KEY, VALUE> {

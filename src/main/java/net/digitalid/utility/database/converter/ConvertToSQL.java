...
public final class ConvertToSQL {
     ...
     */
    public static <V extends SQL<V, ?>> void nonNullable(@Nonnull V object, @Nonnull PreparedStatement preparedStatement, @Nonnull MutableIndex parameterIndex) throws SQLException {
